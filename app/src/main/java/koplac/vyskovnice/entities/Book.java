...
/**
 * Created by gokhantok on 4.07.2017.
 */
...
public class Book implements Serializable {
     ...
     */
    public Book(int id, String name, String category, String peakgroup, String latitude, String longitude, String height, String distance_from_start,
     ...
     * @param picture picture
     */
    public Book(int id, String name, String height, String longitude, String latitude, int picture) {
        this.id = id;
        this.name = name;
        this.height = height;
        this.longitude = longitude;
     ...
     * @return object Peak
     */
    public static Book seekBook(int id){
        Book searchedBook;

        searchedBook=null;
        for(Book auxBook : MainActivity.books){
            if(auxBook.getId()==id){
                searchedBook=auxBook;
                break;
            }
        }
     ...
     */
    public static List<Book> seekBooks(List<Integer> peakIds){
        List<Book> bookFounded;

        bookFounded =new LinkedList<>();
        for(int id:peakIds){
            bookFounded.add(Book.seekBook(id));
        }
        return bookFounded;
    }
    ...
    public String getPeakgroup(String peakgroup){return peakgroup;}
    public void setPeakgroup(String peakgroup){this.peakgroup=peakgroup;}
